      ...
      <div className="max-w-md w-full animate-fade-in relative z-10">
        <div className="bg-white rounded-[2.5rem] shadow-2xl overflow-hidden border border-white/20">
          ...
          <form onSubmit={handleLogin} className="p-10 space-y-6">
            {error && (
              <div className="bg-red-50 text-red-600 p-4 rounded-xl text-xs font-black uppercase text-center border border-red-100 animate-bounce">
                {error}
              </div>
            )}
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="admin"
                  className="w-full pl-12 pr-4 py-4 bg-gray-50 rounded-2xl border border-gray-100 focus:border-[#c5a059] focus:ring-4 focus:ring-[#c5a059]/10 outline-none transition-all font-bold text-[#0a1d37]"
                />
              </div>
            </div>
            ...
            <div className="pt-4 text-center">
              <p className="text-[9px] text-gray-400 font-bold uppercase tracking-widest">
                Credenciais padrao: admin / estrelas2026
              </p>
            </div>
          </form>
        </div>
        ...
        <p className="text-center mt-2 text-white/50 text-[10px] font-bold uppercase tracking-[0.2em]">
